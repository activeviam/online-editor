...
// from https://github.com/mike-lischke/vscode-antlr4/blob/master/themes/complete_dark.json
// ... and converted with https://github.com/Nishkalkashyap/monaco-vscode-textmate-theme-converter
export const AntlrCompleteDarkTheme: editor.IStandaloneThemeData = {
  inherit: false,
  base: "vs-dark",
  ...
  rules: [
    ...
    { foreground: "#e59337", token: "constant" },
    { foreground: "#e59337", token: " constant.other" },
    { foreground: "#e59337", token: "constant.numeric" },
    { foreground: "#e59337", token: "constant.character" },
    { foreground: "#ff6f30", token: "constant.character.escape" },
    {
      fontStyle: "bold",
      foreground: "#c5914c",
    ...
    { foreground: "#c2c299", token: "entity.name.function" },
    ...
    { fontStyle: "bold", foreground: "#aaaaaa", token: "keyword" },
    {
      fontStyle: "bold",
      foreground: "#a9b5ad",
    ...
    { token: "markup" },
    { token: "meta" },
    { fontStyle: "bold", foreground: "#689c9c", token: "storage" },
    { fontStyle: "bold", foreground: "#78a6a6", token: "storage.type" },
    {
      fontStyle: "bold",
      foreground: "#78a6a6",
      token: "storage.modifier",
    },
    { foreground: "#e5bd46", token: "string" },
    { foreground: "#e5bd46", token: "string.quoted" },
    { foreground: "#e5bd46", token: "string.quoted.single" },
    { foreground: "#e5bd46", token: "string.quoted.double" },
    { foreground: "#e5bd46", token: "string.quoted.triple" },
    { foreground: "#e5bd46", token: "string.quoted.other" },
    { foreground: "#e5bd46", token: "string.unquoted" },
    { foreground: "#e0d5b3", token: "string.interpolated" },
    { foreground: "#FF6f30", token: "string.regexp" },
    { foreground: "#eccd73", token: "string.other" },
    ...
    { foreground: "#d7d7c7", token: "support.other.token" },
    {
      foreground: "#CFCFC2",
